    ...
    <div className="min-h-[calc(100vh-80px)] bg-[#f8f5f2] dark:bg-[#050505] flex items-center justify-center p-6 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="max-w-md w-full bg-white/60 dark:bg-black/40 backdrop-blur-xl border border-[#e6d5c3] dark:border-white/10 rounded-3xl shadow-2xl overflow-hidden relative z-10 transition-colors">
        <div className="p-8 text-center border-b border-[#e6d5c3] dark:border-white/5 bg-[#8b4513]/5">
          <h2 className="text-3xl font-serif text-gray-900 dark:text-white tracking-tight">Forgot Password</h2>
          <p className="text-[#8b4513] dark:text-[#d2b48c] text-[10px] mt-2 font-bold uppercase tracking-[0.2em]">Reset your access</p>
        </div>
        ...
        <div className="p-8">
          ...
          {!success && (
            <form onSubmit={handleSubmit}>
              <p className="text-gray-700 dark:text-gray-300 text-sm mb-6 font-light">Enter your email address below and we'll send you a link to reset your password.</p>
              <div className="relative mb-5 group">
                ...
                <input type="email" className="w-full bg-transparent dark:bg-white/5 border border-[#e6d5c3] dark:border-white/10 text-gray-900 dark:text-gray-300 text-sm rounded-xl focus:ring-2 focus:ring-[#8b4513]/50 focus:border-[#8b4513] block pl-10 p-3.5 placeholder-gray-500 dark:placeholder-gray-600 transition-all outline-none" placeholder="Email Address" value={email} onChange={(e) => setEmail(e.target.value)} required />
              </div>
          ...
          <div className="mt-8 text-center pt-6 border-t border-[#e6d5c3] dark:border-white/5">
            <p className="text-gray-600 dark:text-gray-400 text-xs font-light">
              Remember your password? <span onClick={() => navigate('/login')} className="text-[#8b4513] dark:text-[#d2b48c] hover:underline cursor-pointer transition-colors font-bold uppercase ml-1">Log in here</span>
            </p>
          </div>
        </div>
      </div>
