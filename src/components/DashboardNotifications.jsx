...
const DashboardNotifications = () => {
  ...
  return (
    <div className="space-y-6">
      <header className="flex items-center justify-between border-b border-[#2a1b12] pb-4">
        <div>
          <h3 className="text-xl font-serif text-[#d2b48c] tracking-tight flex items-center gap-3">
        ...
        <span className="bg-[#8b4513]/20 text-[#d2b48c] px-3 py-1 rounded-full text-[9px] font-bold uppercase">
      ...
      {notifications.length > 0 ? (
        <div className="space-y-4">
          {notifications.map((msg) => (
            <div key={msg._id} className="bg-[#111111]/40 border border-[#2a1b12] p-5 rounded-2xl hover:border-[#8b4513]/30 transition-all group">
              <div className="flex flex-col md:flex-row md:items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <h4 className="text-white font-serif text-base group-hover:text-[#d2b48c] transition-colors">
                    {msg.subject}
                  </h4>
        ...
        <div className="py-16 bg-[#0c0c0c] border border-dashed border-[#2a1b12] rounded-2xl flex flex-col items-center text-center px-6">
