  ...
  useEffect(() => {
    const fetchGallery = async () => {
      try {
        ...
        // Maintain the deliberate refresh animation
  ...
  return (
    <section className={`py-16 bg-[#f8f5f2] dark:bg-[#0a0a0a] text-gray-900 dark:text-white px-6 font-sans transition-colors duration-500 ${isFullPage ? 'min-h-screen pt-24' : ''}`}>
      <div className="max-w-7xl mx-auto">
        ...
        {/* Load More Button */}
        {!loading && visibleCount < (isFullPage ? memories.length : Math.min(memories.length, 49)) && (
          ...
          >
            ...
            >
              <img 
                ...
                className="max-w-full max-h-[75vh] object-contain shadow-2xl rounded-lg border border-[#3d2b1f]"
              />
