...
const AboutUs = ({ isFullPage = false }) => {
  if (!isFullPage) {
    return (
      <section id="about" className="py-24 bg-[#050505] text-white px-6 font-sans relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
            ...
            <p className="text-[#d2b48c] italic font-serif">
          ...
          <div className="mt-12">
            <Link 
              to="/about" 
              className="inline-block bg-transparent border border-[#3d2b1f] hover:border-[#8b4513] hover:bg-[#1a110b] text-[#d2b48c] px-8 py-4 rounded-lg uppercase tracking-widest text-xs font-bold transition-all duration-300 shadow-lg hover:-translate-y-0.5"
            >
              Our Full Story
            </Link>
          </div>
  ...
  return (
    <section id="about" className="py-24 bg-[#050505] text-white px-6 font-sans min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-[#d2b48c] text-xl md:text-2xl font-light max-w-3xl mx-auto leading-relaxed italic">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
          <div className="space-y-6 text-gray-400 leading-relaxed text-lg">
            <h3 className="text-3xl font-serif text-[#d2b48c] border-b border-[#3d2b1f] pb-2 inline-block">Our Story</h3>
            <p>
          ...
          <div className="bg-[#111111]/90 backdrop-blur-md p-10 border border-[#2a1b12] rounded-xl shadow-2xl relative overflow-hidden group hover:border-[#3d2b1f] transition-all duration-500">
        ...
        <div className="mb-32">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="bg-[#111111]/80 backdrop-blur-sm p-8 border border-[#2a1b12] rounded-xl shadow-xl hover:border-[#3d2b1f] hover:-translate-y-1 transition-all duration-300">
        ...
        {/* Objectives */}
        <div className="bg-[#111111]/90 backdrop-blur-md border border-[#2a1b12] p-10 rounded-xl shadow-2xl relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="flex gap-4">
                ...
                <div>
                  <h4 className="text-[#d2b48c] font-bold text-xs uppercase tracking-tighter mb-2">{obj.title}</h4>
