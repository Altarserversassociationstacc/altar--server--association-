...
const MembershipLockModal = ({ isOpen, onClose, onConfirm, loading }) => {
  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn transition-colors">
      <div className="w-full max-w-md bg-white dark:bg-[#0c0c0c] border border-red-900/30 rounded-3xl overflow-hidden shadow-2xl relative transition-colors">
        ...
        <div className="p-8 text-center">
          ...
          <h2 className="text-2xl font-serif text-gray-900 dark:text-white mb-2 tracking-tight">Lock Membership Profile</h2>
          <p className="text-gray-600 dark:text-gray-500 text-[10px] uppercase tracking-widest font-bold mb-6">Security Protocol Activation</p>
          
          <div className="bg-red-50 dark:bg-red-950/20 border border-red-900/20 rounded-xl p-4 text-left mb-8 space-y-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              onClick={onClose}
              disabled={loading}
              className="w-full bg-transparent border border-gray-300 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-white/5 text-gray-600 dark:text-gray-400 py-3 rounded-xl tracking-widest transition-all uppercase text-[10px]"
            >
              Cancel Operation
            </button>
          </div>
        ...
        <div className="bg-gray-100 dark:bg-black/40 py-3 border-t border-[#e6d5c3] dark:border-white/5 text-center">
